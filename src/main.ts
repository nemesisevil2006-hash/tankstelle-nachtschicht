...
class GameScene extends Phaser.Scene {
  ...
  private touchMovement: Record<Direction, boolean> = {
    up: false,
    down: false,
    left: false,
    right: false
  ...
  update(_: number, delta: number): void {
    ...
    const up =
      ...
      this.keys.W.isDown ||
      this.touchMovement.up;

    const down =
      this.cursors.down.isDown ||
      this.keys.S.isDown ||
      this.touchMovement.down;
  ...
  private startShift(): void {
    ...
    const touchControls = document.querySelector('#touch-controls') as HTMLElement;
  ...
  private setupTouchControls(): void {
    const buttons = document.querySelectorAll<HTMLButtonElement>('.touch-button');
    ...
    window.addEventListener('blur', () => this.resetTouchMovement());
  ...
  private resetTouchMovement(): void {
    ...
    document
      .querySelectorAll<HTMLButtonElement>('.touch-button')
